...
const Footer = () => {
    ...
    return (
        <div id="contact-us" className="relative" data-aos="fade-up" data-aos-offset="200">
            ...
            {/* Footer Main Section */}
            <div className="w-full bg-[#03001417] text-gray-300 py-8 backdrop-blur-md shadow-inner shadow-[#2A0E61]/50 flex flex-col items-center justify-center">
                <div className="container mx-auto px-6 lg:px-20 grid grid-cols-1 md:grid-cols-3 gap-y-8 gap-x-6 text-sm text-center">
