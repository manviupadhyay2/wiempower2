    ...
    return (
        <div id="contact-us" className="relative" data-aos="fade-up" data-aos-offset="200">
            ...
            <div className="w-full bg-[#03001417] text-gray-300 py-6 backdrop-blur-md shadow-inner shadow-[#2A0E61]/50">
                <div className="container mx-auto px-6 lg:px-20 grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                    {/* Get In Touch */}
                    ...
                    <div className="text-center" data-aos="fade-up">
                        ...
                        <ul className="space-y-2">
                            <li><a href="#home" className="hover:text-[#7042f8] transition-colors">IEEE Home</a></li>
                            <li><a href="#about" className="hover:text-[#7042f8] transition-colors">About</a></li>
                            <li><a href="#registration" className="hover:text-[#7042f8] transition-colors">Registration</a></li>
                            <li><a href="#timeline" className="hover:text-[#7042f8] transition-colors">Timeline</a></li>
                            <li><a href="#contact" className="hover:text-[#7042f8] transition-colors">Contact</a></li>
                        </ul>
                    </div>
